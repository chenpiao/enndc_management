...
class Host(models.Model):
    ...
    sn = models.CharField('SN号', max_length=50, null=True, unique=True)
    be_from = models.CharField('资产来源', max_length=20, choices=asset_befrom_choices, blank=True)
    ownership = models.ForeignKey('IndustryGroup', verbose_name='资产归属', related_name='ownership', to_field='name', null=True, blank=True)
    ...
    maintenance_group_name = models.ForeignKey('Maintenance', verbose_name='维保单位', related_name='m_group', to_field='maintenance_group')
...
class HostLog(models.Model):
    sn = models.ForeignKey(Host, verbose_name='服务器sn', to_field='sn')
    state = models.CharField('状态', max_length=50, choices=asset_status_choices, null=True, blank=True)
    peo = models.CharField(verbose_name='申请人', max_length=50, null=True, blank=True)
    phone = models.CharField(verbose_name='联系电话', max_length=50, null=True, blank=True)
    op = models.CharField(verbose_name='经办人', max_length=50, null=True, blank=True)
    notes = models.TextField(verbose_name='备注', max_length=254, null=True, blank=True)
...
class NetworkDevice(models.Model):
    ...
    vendor = models.CharField('生产厂商', max_length=50, null=True, blank=True)
    product_model = models.CharField('产品型号', max_length=100, null=True, blank=True)
    sn = models.CharField('SN号', max_length=50, null=True, blank=True, unique=True)
    be_from = models.CharField('资产来源', max_length=20, choices=asset_befrom_choices, blank=True)
    ...
    power = models.IntegerField('电源数量', null=True, blank=True)
    # 维保信息
    branch = models.CharField('企业名称', max_length=100, null=True, blank=True)
    idc = models.CharField('数据中心', choices=datacenter_choices, max_length=50, null=True, blank=True)
    zone = models.CharField('机柜区域', choices=zone_choices, max_length=20, null=True, blank=True)
    cabinet = models.IntegerField('机柜号', choices=cabinet_choices, null=True, blank=True)
    unit_start = models.IntegerField('机架起始位', choices=rack_unit_choices, null=True, blank=True)
...
class NetworkDeviceLog(models.Model):
    sn = models.ForeignKey(NetworkDevice, verbose_name='网络设备SN', to_field='sn')
    state = models.CharField('状态', max_length=50, choices=asset_status_choices, null=True, blank=True)
    peo = models.CharField(verbose_name='申请人', max_length=50, null=True, blank=True)
    phone = models.CharField(verbose_name='联系电话', max_length=50, null=True, blank=True)
    op = models.CharField(verbose_name='经办人', max_length=50, null=True, blank=True)
    ...
    class Meta:
        ...
        verbose_name = '网络设备变更记录'
        verbose_name_plural = '网络设备变更记录'
...
class Storage(models.Model):
    ...
    sn = models.CharField(u'SN号', unique=True, max_length=50, null=True, blank=True)
...
class StorageLog(models.Model):
    sn = models.ForeignKey(Storage, verbose_name='存储设备SN', to_field='sn')
    state = models.CharField('状态', max_length=50, choices=asset_status_choices, null=True, blank=True)
    peo = models.CharField(verbose_name='申请人', max_length=50, null=True, blank=True)
    phone = models.CharField(verbose_name='联系电话', max_length=50, null=True, blank=True)
    op = models.CharField(verbose_name='经办人', max_length=50, null=True, blank=True)
...
class Tape(models.Model):
    # 资产信息
    # uid = models.UUIDField('uuid', default=uuid.uuid1, auto_created=True, editable=False)
    host = models.ForeignKey(Storage, verbose_name='挂载存储', to_field='sn', null=True, blank=True)
    ...
    sn = models.CharField(u'SN号', max_length=50, null=True, blank=True, unique=True)
    be_from = models.CharField(u'资产来源', max_length=20, choices=asset_befrom_choices, null=True, blank=True)
    content = models.CharField(u'数据内容', max_length=200, null=True, blank=True)
...
class IndustryGroup(models.Model):
    # 公司表（产业集团等）
    # uid = models.UUIDField('uuid', default=uuid.uuid1, auto_created=True, editable=False)
    name = models.CharField('公司名称', max_length=100, null=True, blank=True, unique=True)
    # 自动信息
    born_time = models.DateTimeField(u'创建时间', default=datetime.datetime.now, auto_created=True)
    update_time = models.DateTimeField(u'上次修改时间', auto_now=True, editable=True, blank=True, null=True)
...
class Maintenance(models.Model):
    # 维保单位
    # uid = models.UUIDField('uuid', default=uuid.uuid1, auto_created=True, editable=False)
    maintenance_group = models.CharField(u'维保单位名称', max_length=100, unique=True, null=True)
...
class HostSparePart(models.Model):
    host = models.ForeignKey(Host, null=True, blank=True, verbose_name='挂载主机', to_field='sn')
    ...
    capacity = models.CharField('容量(G)', max_length=50, blank=True, null=True)
    # 重要时间
    born_time = models.DateTimeField(u'创建时间', default=datetime.datetime.now, auto_created=True)
...
class NetworkSparePart(models.Model):
    ...
    host = models.ForeignKey(NetworkDevice, verbose_name='挂载设备', null=True, blank=True, to_field='sn')
    sn = models.CharField('备件SN', max_length=50, null=True, blank=True)
    type = models.CharField('备件类型', max_length=50, choices=net_part_type_choices, null=True, blank=True)
    pro_model = models.CharField('型号', max_length=50, null=True, blank=True)
    vendor = models.CharField('生产厂商', max_length=50, null=True, blank=True)
    # 重要时间
    born_time = models.DateTimeField(u'创建时间', default=datetime.datetime.now, auto_created=True)
...
class StorageSparePart(models.Model):

    host = models.ForeignKey(Storage, verbose_name='存储备件', null=True, blank=True, to_field='sn')
    sn = models.CharField('备件SN', max_length=50, null=True, blank=True, unique=True)
    model = models.CharField('型号', max_length=50, choices=storage_sparepart_type_choices, null=True, blank=True)
    vendor = models.CharField('生产厂商', max_length=50, null=True, blank=True)
    capacity = models.CharField('容量G', max_length=50, null=True, blank=True)
